...
class InsertProducts
{
        ...
        if (false !== ($getfile = fopen($csv_file, 'r'))) {
            ...
            while (false !== ($data = fgetcsv($getfile, 1000, ','))) {
	            ...
	            $cert = $slice[7];
                 ...
                 $reault_array [] = $this->insert_update_products($netsuite_id ,$post_title,$cat, $description,$tech);
    ...
    function insert_update_products($netsuite_id ,$post_title,$cat, $description,$tech)
    {
